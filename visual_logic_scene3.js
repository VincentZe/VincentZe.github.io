...
this.procedures["SetCamera2Position"] = SetCamera2Position;
this.procedures["UpdateWorldScale"] = UpdateWorldScale;
this.procedures["SetCameraPosition"] = SetCameraPosition;
this.procedures["SetActiveCamera"] = SetActiveCamera;
this.procedures["UpdateAirRotation"] = UpdateAirRotation;
this.procedures["SetTargetPosition"] = SetTargetPosition;
this.procedures["UpdateWorldRotation"] = UpdateWorldRotation;
this.procedures["GetCameraPosition"] = GetCameraPosition;
this.procedures["GetTargetPosition"] = GetTargetPosition;
this.procedures["PauseWorldRotation"] = PauseWorldRotation;
this.procedures["ResumeWorldRotation"] = ResumeWorldRotation;
this.procedures["SetEviorColor"] = SetEviorColor;
this.procedures["StartWorldRotation"] = StartWorldRotation;
this.procedures["HideObjectsInCollection"] = HideObjectsInCollection;
this.procedures["HideObjects"] = HideObjects;
this.procedures["ResetWorldRotation"] = ResetWorldRotation;
...
this.procedures["AirAgeTagBandToAirFlow"] = AirAgeTagBandToAirFlow;
this.procedures["AirAgeTagBandToAirFlowDiagonal"] = AirAgeTagBandToAirFlowDiagonal;
...
this.procedures["ReplaceHdri"] = ReplaceHdri;
this.procedures["SetWorldRoation"] = SetWorldRoation;
this.procedures["SetObjPosition"] = SetObjPosition;
this.procedures["GetCameraUpDirection"] = GetCameraUpDirection;
this.procedures["GetCameraRightDirection"] = GetCameraRightDirection;
this.procedures["ApplyObjTrans"] = ApplyObjTrans;
...
var PROC = {
    ...
    "SetCamera2Position": SetCamera2Position,
    "UpdateWorldScale": UpdateWorldScale,
    "SetCameraPosition": SetCameraPosition,
    "SetActiveCamera": SetActiveCamera,
    "UpdateAirRotation": UpdateAirRotation,
    "SetTargetPosition": SetTargetPosition,
    "UpdateWorldRotation": UpdateWorldRotation,
    "GetCameraPosition": GetCameraPosition,
    "GetTargetPosition": GetTargetPosition,
    "PauseWorldRotation": PauseWorldRotation,
    "ResumeWorldRotation": ResumeWorldRotation,
    "SetEviorColor": SetEviorColor,
    "StartWorldRotation": StartWorldRotation,
    "HideObjectsInCollection": HideObjectsInCollection,
    "HideObjects": HideObjects,
    "ResetWorldRotation": ResetWorldRotation,
    ...
    "AirAgeTagBandToAirFlow": AirAgeTagBandToAirFlow,
    "AirAgeTagBandToAirFlowDiagonal": AirAgeTagBandToAirFlowDiagonal,
    "SetTemperature": SetTemperature,
    "SetParticleT2": SetParticleT2,
    "SetAirFlowSpeed": SetAirFlowSpeed,
    "animateH2Ov3Diagonal": animateH2Ov3Diagonal,
    "Ani_ShowAirFlow": Ani_ShowAirFlow,
    "animateFlowH2O": animateFlowH2O,
    "animateCO2v3Diagonal": animateCO2v3Diagonal,
    "animateFlowPM25": animateFlowPM25,
    "Ani_HideAirFlow": Ani_HideAirFlow,
    "animateH2Ov3Diagonal2": animateH2Ov3Diagonal2,
    ...
    "ReplaceHdri": ReplaceHdri,
    "SetWorldRoation": SetWorldRoation,
    "SetObjPosition": SetObjPosition,
    "GetCameraUpDirection": GetCameraUpDirection,
    "GetCameraRightDirection": GetCameraRightDirection,
    "ApplyObjTrans": ApplyObjTrans,
};

var Matrix, CameraInfos, cameraName, rot, name2, FloatColor, CollectionName, ObjectList, CO2Speed, ToValue, LastValue, AirFlowSpeed, HOSpeed, PMSpeed, COSpeed, textureUrl, WorldRoation, ObjName, Position, CamMtrix, H2OSpeed, i, Dir, PM25Speed;
...
function SetCamQuaternion(Matrix) {
  ...
  var VARS = Object.defineProperties({}, {
    ...
    "cameraName": { get: function() { return cameraName; }, set: function(val) { cameraName = val; } },
    "rot": { get: function() { return rot; }, set: function(val) { rot = val; } },
    "name": { get: function() { return name2; }, set: function(val) { name2 = val; } },
    ...
    "textureUrl": { get: function() { return textureUrl; }, set: function(val) { textureUrl = val; } },
    "WorldRoation": { get: function() { return WorldRoation; }, set: function(val) { WorldRoation = val; } },
    "ObjName": { get: function() { return ObjName; }, set: function(val) { ObjName = val; } },
    "Position": { get: function() { return Position; }, set: function(val) { Position = val; } },
...
// Describe this function...
function GetCameraRotation(cameraName) {
  return getObjTransform(cameraName, true, 'rotation', 'xyz');
}

// Describe this function...
function SetCamera2Position(CameraInfos) {
  setObjTransform('A.MasterCamera.disablePanning', false, 'position', [CameraInfos[0], CameraInfos[1], CameraInfos[2]], false);
}

// Describe this function...
function UpdateWorldScale(rot, name2) {
  setObjTransform(name2, false, 'scale', rot, false);
}

// Describe this function...
function SetCameraPosition(CameraInfos, cameraName) {
  setObjTransform(cameraName, true, 'position', [CameraInfos[0], CameraInfos[1], CameraInfos[2]], false);
}
...
// Describe this function...
function SetActiveCamera(cameraName) {
  setActiveCamera(cameraName);
}

// Describe this function...
function UpdateAirRotation(rot, name2) {
  setObjTransform(name2, false, 'rotation', rot, false);
}
...
// Describe this function...
function UpdateWorldRotation(rot) {
  setObjTransform('BackgroundSphere.001', false, 'rotation', rot, false);
}

// Describe this function...
function GetCameraPosition(cameraName) {
  return getObjTransform(cameraName, true, 'position', 'xyz');
}
...
// Describe this function...
function PauseWorldRotation() {

  operateAnimation('PAUSE', 'Center', null, null, 'AUTO', 1,
...
// Describe this function...
function ResumeWorldRotation() {

  operateAnimation('RESUME', 'Center', null, null, 'AUTO', 1,
          function() {}, undefined, false);
...
function StartWorldRotation() {
  ...
  operateAnimation('PLAY', 'Center', 0, 360, 'AUTO', 0.08,
          function() {}, undefined, false);
...
function ResetWorldRotation() {
  ...
  operateAnimation('STOP', 'Center', null, null, 'AUTO', 1,
          function() {}, undefined, false);

      }

// Describe this function...
function ShowObjectsInCollection(CollectionName) {
...
// Describe this function...
function AirAgeTagBandToAirFlow() {
...
// Describe this function...
function AirAgeTagBandToAirFlowDiagonal() {
  bindHTMLObject('AirAgeTag.004', 'AirAgeTag1', false);
  bindHTMLObject('AirAgeTag.005', 'AirAgeTag2', false);
  bindHTMLObject('AirAgeTag.006', 'AirAgeTag3', false);
}
...
// Describe this function...
function animateH2Ov3Diagonal(HOSpeed) {

  operateAnimation('STOP', getAnimations(['GROUP', 'Particles.v3.H2O']), null, null, 'AUTO', 1,
          function() {}, undefined, false);


  operateAnimation('PLAY', getAnimations(['GROUP', 'Particles.v3.H2O']), 0, 200, 'AUTO', HOSpeed,
          function() {}, undefined, false);
...
// Describe this function...
function animateCO2v3Diagonal(HOSpeed) {
...
function animateFlowPM25(PMSpeed) {
  ...
  operateAnimation('PLAY', getAnimations(['GROUP', 'Particles.v3.PM25']), 0, 200, 'AUTO', PMSpeed,
          function() {}, undefined, false);
...
// Describe this function...
function animateH2Ov3Diagonal2(HOSpeed) {
...
function animateFlowCO2(COSpeed) {
  ...
  operateAnimation('PLAY', getAnimations(['GROUP', 'Particles.v3.CO2']), 0, 200, 'AUTO', COSpeed,
          function() {}, undefined, false);
...
function animateCollection(HOSpeed, CollectionName) {
  ...
  operateAnimation('PLAY', getAnimations(['GROUP', CollectionName]), 0, 200, 'AUTO', HOSpeed,
          function() {}, undefined, false);
...
// Describe this function...
function ReplaceHdri(textureUrl) {
  replaceTexture('envirnoment', '20211221161204.jpg', textureUrl, function() {});
}

// Describe this function...
function SetWorldRoation(WorldRoation) {
  setMaterialValue('Verge3D_Environment_World', 'ZRotation', WorldRoation);
  console.log(WorldRoation);
}

// Describe this function...
function SetObjPosition(ObjName, Position) {
  for (var i_index in ObjName) {
    i = ObjName[i_index];
    setObjTransform(i, true, 'position', Position, false);
  }
}

// Describe this function...
function GetCameraUpDirection() {
  var VARS = Object.defineProperties({}, {
    "Matrix": { get: function() { return Matrix; }, set: function(val) { Matrix = val; } },
    "CameraInfos": { get: function() { return CameraInfos; }, set: function(val) { CameraInfos = val; } },
    "cameraName": { get: function() { return cameraName; }, set: function(val) { cameraName = val; } },
  ...
  Function('app', 'v3d', 'VARS', 'PROC', (('let UpDir = new THREE.Vector3(0,1.0,0); ' + '\n' +
  'let ForwardDir = new THREE.Vector3(0,0,-1.0); // the camera looks down its negative-z axis ' + '\n' +
  'let dir = new THREE.Vector3(); ' + '\n' +
  '' + '\n' +
  'let camera=app.scene.getObjectByName(\'MasterCamera\');' + '\n' +
  'dir.copy(ForwardDir).applyMatrix4(camera.matrixWorld);' + '\n' +
  '// console.log(camera.matrixWorld)' + '\n' +
  'VARS[\'Dir\']=dir;')))(appInstance, v3d, VARS, PROC);
...
function GetCameraRightDirection() {
  ...
  Function('app', 'v3d', 'VARS', 'PROC', (('let RightDir = new THREE.Vector3(1.0,0,0); ' + '\n' +
  'let ForwardDir = new THREE.Vector3(0,0,-1.0); // the camera looks down its negative-z axis ' + '\n' +
  'let dir = new THREE.Vector3(); ' + '\n' +
  '' + '\n' +
  'let camera=app.scene.getObjectByName(\'MasterCamera\');' + '\n' +
  'dir.copy(RightDir).applyMatrix4(camera.matrixWorld);' + '\n' +
...
// Describe this function...
function ApplyObjTrans(ObjName, Position) {
  for (var i_index2 in ObjName) {
    i = ObjName[i_index2];
    setObjTransform(i, true, 'position', Position, true);
  }
}
...
changeVis(['GROUP', 'AirFlow.Diagonal'], false);
changeVis(['GROUP', 'Particles.v3.H2O.Diagonal'], false);
changeVis(['GROUP', 'Particles.v3.CO2.Diagonal'], false);
changeVis(['GROUP', 'Particles.v3.PM25.Diagonal'], false);
...
setMaterialValue('Air.Flow.Style.1', 'AirOpacity', 0);
setScreenScale(1.2);
AirAgeTagBandToAirFlowDiagonal();
setObjTransform('BackgroundSphere.001', true, 'scale', [0.05, 0.05, 0.05], false);
