...
window.addEventListener('load', function () {
    ...
    (function () {
        ...
        let sceneId = getQueryVariable('sceneId')
        ...
        switch (sceneId) {
            case '1':
                logicURL = params.logic ? params.logic : '__LOGIC__visual_logic_scene1.js'.replace('__LOGIC__', '');
                sceneURL = params.load ? params.load : '__URL__model/AirFlow_T3_Scene1.gltf.xz'.replace('__URL__', '');
                break;
            case '2':
                logicURL = params.logic ? params.logic : '__LOGIC__visual_logic_scene2.js'.replace('__LOGIC__', '');
                sceneURL = params.load ? params.load : '__URL__model/AirFlow_T3_Scene2.gltf.xz'.replace('__URL__', '');
                break;
            case '3':
                logicURL = params.logic ? params.logic : '__LOGIC__visual_logic_scene3.js'.replace('__LOGIC__', '');
                sceneURL = params.load ? params.load : '__URL__model/AirFlow_T3_Scene3.gltf.xz'.replace('__URL__', '');
                break;
    ...
    function prepareExternalInterface(app) {
        ...
        // }
        app.ExternalInterface.ua = function () {
